#!/usr/bin/env python3
"""
搜索 GitHub 上的 Claude 相关 CLI 项目（完全修复版）
"""
...
def main():
    print("=" * 80)
    print("🔍 搜索 GitHub 上的 Claude 相关 CLI 项目（完全修复版）")
    print("=" * 80)
    print()
    ...
    print(f"{'排名':<6} {'项目名称':<50} {'Stars':<10} {'Forks':<10} {'语言':<12} {'描述'}")
    print("-" * 80)
    ...
    for i, repo in enumerate(sorted_repos[:50], 1):
        ...
        print(f"{i:<6} {name:<50} {stars:<10} {forks:<10} {language:<12} {description}")
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        f.write("---\n\n")
        f.write("## 🏆 Top 50 项目\n\n")
        f.write("| 排名 | 项目 | Stars | Forks | 语言 | 描述 |\n")
        f.write("|------|------|-------|-------|------|------|\n")
        ...
        for i, repo in enumerate(sorted_repos[:50], 1):
            ...
            f.write(f"| {i} | {name} | {stars} | {forks} | {language} | {description} | {url} |\n")
